...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
	...
	return (
		<div className="w-full" ref={containerRef}>
			<div className="pt-20 lg:py-10 px-10">
				<h2 className="text-lg md:text-4xl mb-4 text-black font-bold max-w-4xl">
					My Experience
				</h2>
			</div>

			<div ref={ref} className="relative px-10 pb-20">
				{data.map((item, index) => (
					<div
						key={index}
						...
						<div className="relative pl-20 pr-4 md:pl-4 w-full pb-16 lg:pb-24">
							<h3 className="md:hidden block text-2xl mb-4 text-left font-bold text-neutral-500 dark:text-neutral-500">
								{item.title}
							</h3>
							<h6 className="text-lg font-medium text-neutral-500 mb-4">
								{item.date}
							</h6>
							{item.content}{" "}
						</div>
